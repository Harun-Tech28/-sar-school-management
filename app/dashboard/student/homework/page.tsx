        ...
        <main className="flex-1 p-6 overflow-auto">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground mt-1">View and manage your homework assignments</p>
            </div>
            ...
            {homeworkList.length > 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-4 rounded-lg bg-accent/10">
                    ...
                    <p className="text-4xl font-bold text-accent">
                      {Math.round(homeworkList.filter(h => h.grade).reduce((sum, h) => sum + (h.grade || 0), 0) / homeworkList.filter(h => h.grade).length) || 0}%
                    </p>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-chart-3/10">
                    ...
                    <p className="text-4xl font-bold text-chart-3">
                      {Math.round((submittedCount / homeworkList.length) * 100) || 0}%
                    </p>
                  </div>
              ...
              <Card className="p-12 bg-card border-border text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">No Homework Assignments</h3>
                <p className="text-muted-foreground">Your homework assignments will appear here once they are assigned by your teachers.</p>
              </Card>
            )}
          </div>
        </main>
