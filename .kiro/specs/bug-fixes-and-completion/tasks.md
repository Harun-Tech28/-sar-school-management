...
- [x] 2. Update Next.js configuration
...
- [x] 4. Enhance authentication with password validation


- [x] 4.1 Create password validation utility
...
- [x] 5.2 Enhance SyncManager with retry logic
...
- [x] 5.3 Update OfflineIndicator component
...
- [x] 7. Create shared dashboard layout component
...
- [x] 8.1 Audit all dashboard routes
...
- [x] 8.2 Implement placeholder content for incomplete pages
...
- [x] 10. Fix Parents menu item visibility in admin sidebar



  - Investigate why Parents menu item is not rendering despite being in code
  - Update Parents menu item to use a distinct icon (UserCircle2 or UsersRound)
  - Verify Parents menu item appears between Students and Teachers
  - Test navigation to Parents management page
