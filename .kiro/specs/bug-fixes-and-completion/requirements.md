...
**User Story:** As an admin user, I want to see the Parents menu item in the sidebar navigation, so that I can access the Parents management page

#### Acceptance Criteria

1. WHEN an admin user views the sidebar, THE System SHALL display the Parents menu item between Students and Teachers
2. THE System SHALL use a distinct icon for the Parents menu item to differentiate it from Students
3. WHEN an admin user clicks the Parents menu item, THE System SHALL navigate to the Parents management page
4. THE System SHALL highlight the Parents menu item when the user is on the Parents page
5. THE System SHALL render the Parents menu item consistently across all browsers
