...
export default function GradesPage() {
  ...
  const averageScore = grades.length > 0 ? (grades.reduce((sum, g) => sum + g.score, 0) / grades.length).toFixed(1) : "0"
            ...
            <div className="bg-card rounded-lg border border-border overflow-hidden shadow-sm">
              {grades.length > 0 ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-600 text-lg mb-2">No students to grade</p>
                  <p className="text-gray-500 text-sm">Select a class with students to enter grades</p>
                </div>
              )}
            </div>
          </div>
